...
def test_add_contact_to_group(app, db):
    ...
    # проверка, пробегаемся по группам - ищем первый контакт из списка контактов, принадлежищего заданной группе
    ...
    if len(contacts_in_group) == 0:
        ...
        app.contact.remove_contact_from_group(contacts[0], group_is_real)
